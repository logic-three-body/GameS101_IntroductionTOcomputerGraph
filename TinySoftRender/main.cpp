...
int main(int argc, char** argv) {
	...
	Vec3f p3(0, 0.5, -3), p4(1, 0, 3), p5(1, 1, 2);
	Vec3f pt[3],pt1[3];
	//pt[0] = r.world2screen(p0);
	//pt[1] = r.world2screen(p1);
	//pt[3] = r.world2screen(p2);

	pt[0] = r.m2v(r.GetViewPort()*r.v2m(p0));
	pt[1] = r.m2v(r.GetViewPort()*r.v2m(p1));
	pt[2] = r.m2v(r.GetViewPort()*r.v2m(p2));
	Triangle3f t(pt);
	pt1[0] = r.m2v(r.GetViewPort()*r.v2m(p3));
